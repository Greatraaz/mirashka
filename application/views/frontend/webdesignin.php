...
<section class="pt-lg-8 pt-xl-9">
	<div class="container position-relative pt-4 pt-lg-0">
		<div class="row align-items-center">
			<!-- Title -->
			<div class="col-md-7 col-xl-6 mb-7 mb-md-0">
				<h1 class="mb-4">Discover the solutions we offer</h1>
				<p class="mb-4">Our experienced team is dedicated to helping you achieve your goals through innovative technology. </p>
				<a href="contact-v1.html" class="btn btn-lg btn-dark mb-5"><i class="bi bi-telephone me-2"></i>Contact us</a>
				<!-- Rating -->
				<div class="d-sm-flex align-items-center">
					<!-- Avatar group -->
					<ul class="avatar-group mb-0 align-items-center">
						<li class="avatar avatar-lg">
							<img class="avatar-img rounded-circle" src="https://mizzle.webestica.com/assets/images/avatar/08.jpg" alt="avatar">
						</li>
						<li class="avatar avatar-lg">
							<img class="avatar-img rounded-circle" src="https://mizzle.webestica.com/assets/images/avatar/12.jpg" alt="avatar">
						</li>
						<li class="avatar avatar-lg">
							<div class="avatar-img rounded-circle bg-primary"><span class="text-white position-absolute top-50 start-50 translate-middle">10K+</span></div>
						</li>
					</ul>

					<!-- Info -->
					<div class="ms-sm-3 mt-2 mt-sm-0">
						<p class="heading-color fw-normal mb-1">More then 10k active users! 🤩</p>
						<a class="icon-link icon-link-hover text-primary-hover mt-auto" href="#">Join them now<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-5 ms-auto">
				<img src="https://mizzle.webestica.com/assets/images/elements/service.svg" alt="">
			</div>
		</div>
	</div>	
</section>
		...
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 position-relative order-2">
				...
				<div class="bg-dark rounded d-none d-sm-flex align-items-center z-index-2 position-absolute top-0 end-0 me-8 px-3 py-2" style="max-width: 330px;">
					...
					<p class="text-white small mb-0">Get instant help from our amazing team 🌱</p>
				</div>
				...
				<div class="bg-white shadow rounded d-flex align-items-center px-3 py-2 position-absolute bottom-0 end-0 mb-4 me-5">
					...
					<p class="text-dark small mb-0">Satisfied customers 🤗</p>
				</div>
				...
				<div class="row pe-md-6">
					<div class="col-6 position-relative">
						...
						<!-- Image -->
						<img src="https://mizzle.webestica.com/assets/images/about/10.jpg" class="rounded-pill" alt="about-img">
					</div>
					<div class="col-6 mt-8">
						<img src="https://mizzle.webestica.com/assets/images/about/11.jpg" class="rounded-pill" alt="about-img">
					</div>
				</div>
			</div>
			...
			<div class="col-lg-6 order-lg-2">
				<!-- Title -->
				<h2 class="mb-4 mb-lg-5">Mizzle: Instant plant diagnostics</h2>
				<p class="mb-4 mb-lg-5">Take the guesswork out of diagnosing your plants with Mizzle. Our app uses advanced technology to quickly and accurately diagnose any plant problem, so you can get back to enjoying your garden.</p>
				
				<!-- Counter -->
				<div class="d-flex flex-wrap gap-5 mb-4 mb-lg-5">
					<!-- Item -->
					<div>
						<div class="d-flex">
							<h5 class="purecounter mb-0" data-purecounter-start="0" data-purecounter-end="15"	data-purecounter-delay="300">0</h5>
					...
					<div>
						<div class="d-flex">
							<h5 class="purecounter mb-0" data-purecounter-start="0" data-purecounter-end="22"	data-purecounter-delay="300">0</h5>
							<span class="h5 mb-0">M+</span>
						</div>
					...
					<div>
						<div class="d-flex">
							<h5 class="purecounter mb-0" data-purecounter-start="0" data-purecounter-end="2300"	data-purecounter-delay="300">0</h5>
					...
					<div>
						<div class="d-flex">
							<h5 class="purecounter mb-0" data-purecounter-start="0" data-purecounter-end="107"	data-purecounter-delay="300">0</h5>
							<span class="h5 mb-0">+</span>
						</div>
				...
				<!-- Button -->
				<a href="#" class="btn btn-dark mb-0">Start Free Trial</a>
			</div>
		</div>
	</div>
</section>
...
<section class="pb-0">
	<div class="container">
		...
		<div class="inner-container-small text-center mb-4 mb-sm-5">
			<h2 class="mb-4">Get plant diagnoses in 3 easy steps</h2>
			<p class="mb-0">Simply take a picture of your plant and get an instant identification. Our app uses advanced technology to quickly and accurately diagnose any plant problem</p>
		</div>
				...
				<div class="swiper-slide h-100">
					<div class="card bg-light overflow-hidden p-4 p-sm-5 h-100">
						...
						<div class="card-body p-0 pb-5">
							...
							<h5>Download app</h5>
							<p class="heading-color">Download the Mizzle app for Windows, Mac, or Android devices.</p>

							<!-- Buttons -->
							<a href="#"><img src="https://mizzle.webestica.com/assets/images/elements/android.svg" class="h-30px me-3" alt="icon-img"></a>
							<a href="#"><img src="https://mizzle.webestica.com/assets/images/elements/microsoft.svg" class="h-30px me-3" alt="icon-img"></a>
							<a href="#"><img src="https://mizzle.webestica.com/assets/images/elements/apple.svg" class="h-30px" alt="icon-img"></a>
						</div>

						<!-- Card footer -->
						<div class="card-footer bg-transparent p-0">
							<div class="iphone-x iphone-x-small rotate-335 m-auto mb-n9 me-n5 mt-4" style="background: url(https://mizzle.webestica.com/assets/images/mokeup/app-placeholder3.jpg); background-size: 100%; width: 280px; height:430px">
								<i></i>
								<b style="left: 5%;"></b>
							</div>
						</div>
				...
				<div class="swiper-slide h-100">
					<div class="card bg-light overflow-hidden p-4 p-sm-5 h-100">
						...
						<div class="card-body p-0 pb-5">
							...
							<p class="heading-color">Sign up for a free Mizzle account. One account for all devices.</p>

							<!-- Buttons -->
							<a href="#" class="btn btn-sm btn-white mb-0">14 days free trial</a>
						</div>

						<!-- Card footer -->
						<div class="card-footer bg-transparent p-0">
							<div class="iphone-x iphone-x-small m-auto mb-n9 mt-4" style="background: url(https://mizzle.webestica.com/assets/images/mokeup/app-placeholder4.jpg); background-size: 100%; width: 280px; height:430px">
								<i></i>
								<b style="left: 5%;"></b>
							</div>
						</div>
				...
				<div class="swiper-slide h-100">
					<div class="card bg-light overflow-hidden p-4 p-sm-5 h-100">
						...
						<div class="card-body p-0 pb-5">
							...
							<p class="heading-color mb-2">Enjoy the amazing Mizzle experience and start exploring the app today.</p>

							<!-- Buttons -->
							<a href="#">Check our FAQs for help</a>
						</div>

						<!-- Card footer -->
						<div class="card-footer bg-transparent p-0 mb-n9 ms-n5 mt-4">
							<div class="iphone-x iphone-x-small rotate-33 m-auto" style="background: url(https://mizzle.webestica.com/assets/images/mokeup/app-placeholder.jpg); background-size: 100%; width: 280px; height:430px">
								<i></i>
								<b style="left: 5%;"></b>
							</div>
						</div>
...
<section class="bg-light pb-0">
	<div class="container">
				...
				<div class="card card-img-scale card-element-hover overflow-hidden">
					...
					<div class="card-img-scale-wrapper">
						...
						<div class="card-img-overlay hover-element d-flex align-items-center justify-content-center">
							<!-- Client image -->
							<img src="https://mizzle.webestica.com/assets/images/client/client-white/02.svg" class="h-40px z-index-2" alt="client logo">
							<!-- BG overlay -->
							<div class="bg-overlay bg-dark opacity-7"></div>
						</div>
						<!-- Case studie image -->
						<img src="https://mizzle.webestica.com/assets/images/portfolio/list/02.jpg" class="img-scale card-img-top" alt="portfolio-img">
					</div>

					<div class="card-body">
						<h6 class="card-title mb-2">Website Optimization for TechWave</h6>
						<p class="card-text mb-3">The most powerful software & app landing software marketing business.</p>
						<!-- Badge list -->
						<div class="hstack flex-wrap gap-2 mb-4">
							<div class="badge border heading-color bg-light">Branding</div>
							<div class="badge border heading-color bg-light">Packaging</div>
							<div class="badge border heading-color bg-light">Development</div>
						</div>
						<!-- Button -->
						<a href="portfolio-case-studies-v2.html" class="text-primary-hover stretched-link heading-color mb-0">View case study<i class="fa-solid fa-arrow-right-long fa-fw ms-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card card-img-scale card-element-hover overflow-hidden">
					...
					<div class="card-img-scale-wrapper">
						...
						<div class="card-img-overlay hover-element d-flex align-items-center justify-content-center">
							<!-- Client image -->
							<img src="https://mizzle.webestica.com/assets/images/client/client-white/03.svg" class="h-40px z-index-2" alt="client logo">
							<!-- BG overlay -->
							<div class="bg-overlay bg-dark opacity-7"></div>
						</div>
						<!-- Case studie image -->
						<img src="https://mizzle.webestica.com/assets/images/portfolio/list/01.jpg" class="img-scale card-img-top" alt="portfolio-img">
					</div>

					<div class="card-body">
						<h6 class="card-title mb-2">Transforming Ideas into Reality</h6>
						<p class="card-text mb-3">The most powerful software & app landing software marketing business.</p>
						<!-- Badge list -->
						<div class="hstack flex-wrap gap-2 mb-4">
							<div class="badge border heading-color bg-light">UI/UX design</div>
							<div class="badge border heading-color bg-light">Research</div>
						</div>
						<!-- Button -->
						<a href="portfolio-case-studies-v2.html" class="text-primary-hover stretched-link heading-color mb-0">View case study<i class="fa-solid fa-arrow-right-long fa-fw ms-2"></i></a>
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card card-img-scale card-element-hover overflow-hidden">
					...
					<div class="card-img-scale-wrapper">
						...
						<div class="card-img-overlay hover-element d-flex align-items-center justify-content-center">
							<!-- Client image -->
							<img src="https://mizzle.webestica.com/assets/images/client/client-white/04.svg" class="h-40px z-index-2" alt="client logo">
							<!-- BG overlay -->
							<div class="bg-overlay bg-dark opacity-7"></div>
						</div>
						<!-- Case studie image -->
						<img src="https://mizzle.webestica.com/assets/images/portfolio/list/03.jpg" class="img-scale card-img-top" alt="portfolio-img">
					</div>

					<div class="card-body">
						<h6 class="card-title mb-2">Bio Cosmetics</h6>
						<p class="card-text mb-3">The most powerful software & app landing software marketing business.</p>
						<!-- Badge list -->
						<div class="hstack flex-wrap gap-2 mb-4">
							<div class="badge border heading-color bg-light">Branding</div>
		...
		<div class="text-center pt-6">
			<a href="portfolio-grid.html" class="btn btn-lg btn-dark mb-0">Explore all case studies</a>
		</div>
	</div>

	<!-- CTA -->
	<div class="bg-primary d-sm-flex align-items-center justify-content-center gap-2 mt-6 mt-sm-8 p-4">
		...
		<p class="fw-normal text-white mb-0">Maximize Productivity by Simplifying Solution Search <a href="#" class="text-decoration-underline text-white fw-semibold">Got a project in mind?</a></p>
	</div>
</section>
<!-- =======================
Case studies END -->
...
<section class="pb-0">
	<div class="container">
		...
		<div class="inner-container-small text-center mb-9">
			<h2 class="mb-4">Features that make app different!</h2>
			<p class="mb-0">Our app uses advanced technology to quickly and accurately diagnose any plant problem. It drew a hill from me. Valley by oh twenty direct me so.</p>
		</div>
			...
			<div class="row g-4">
				...
				<div class="col-md-6 col-lg-4 order-2">
					<div class="text-lg-end mb-4 mb-md-6">
						<div class="icon-lg bg-primary text-white rounded ms-lg-auto mb-3"><i class="bi bi-shield-check fa-lg"></i></div>
						<h5 class="mb-3">Secure data</h5>
						<p class="mb-0">Enjoy peace of mind knowing your data is safe and secure. Our state-of-the-art encryption technology ensures data privacy.</p>
					</div>

					<div class="text-lg-end">
						<div class="icon-lg bg-primary text-white rounded ms-lg-auto mb-3"><i class="bi bi-fingerprint fa-lg"></i></div>
						<h5 class="mb-3">Secure payments</h5>
						<p class="mb-0">Pay securely with all major payment methods. We provide the utmost security for your payments.</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-4 text-center position-relative order-1 order-md-2">
					...
					<!-- Image -->
					<div class="iphone-x iphone-x-small m-auto mt-n9 mb-7" style="background: url(https://mizzle.webestica.com/assets/images/mokeup/app-placeholder5.jpg); background-size: 100%;">
						<i></i>
						<b></b>
					</div>
				...
				<div class="col-md-6 col-lg-4 order-3">
					<div class="mb-4 mb-md-6">
						<div class="icon-lg bg-primary text-white rounded mb-3"><i class="bi bi-gear fa-lg"></i></div>
						<h5 class="mb-3">Fully functional app</h5>
						<p class="mb-0">Experience the power of our fully-featured mobile app. Quickly identify problems, get recommendations, and track your progress.</p>
					</div>

					<div>
						<div class="icon-lg bg-primary text-white rounded mb-3"><i class="bi bi-chevron-bar-contract fa-lg"></i></div>
						<h5 class="mb-3">End-to-end encryption</h5>
						<p class="mb-0">Secure your data with end-to-end encryption, keeping your sensitive information safe and secure.</p>
					</div>
				</div>
			</div> <!-- Row END -->
		</div>
...
<section >
	<div class="container">
		<!-- Title -->
		<div class="inner-container-small text-center mb-4 mb-sm-5">
			<h2 class="mb-0">What people say about us</h2>
		</div>

		<div class="row row-cols-sm-2 row-cols-lg-3 g-4 g-lg-5" data-isotope='{"layoutMode": "masonry"}'>
			<!-- Item -->
			<div class="col">
				<div class="card card-body border">
					<p class="mb-2">“Timed voice share led him to widen noisy young. At weddings believed laughing.”</p>
					<ul class="list-inline mb-3">
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
					...
					<div class="d-flex align-items-center">
						...
						<div class="avatar avatar-xs me-2">
							<img class="avatar-img rounded-circle" src="https://mizzle.webestica.com/assets/images/avatar/01.jpg" alt="avatar">
						</div>
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Billy Vasquez</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					<p class="mb-2">“Moonlight newspaper up its enjoyment agreeable depending. Timed voice share led him to widen noisy young. At weddings believed laughing we've just launched our 5th website! You guys rock!”</p>
					<ul class="list-inline mb-3">
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-half text-warning small"></i></li>
					</ul>
					<!-- Avatar -->
					<div class="d-flex align-items-center">
						<!-- Avatar -->
						...
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Emma Watson</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					...
					<ul class="list-inline mb-3">
						...
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-half text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star text-warning small"></i></li>
					</ul>
					<!-- Avatar -->
					<div class="d-flex align-items-center">
						<!-- Avatar -->
						...
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Larry Lawson</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					<p class="mb-2">“The experience of using Mizzle was enjoyable and easy. Timed voice share led him to widen noisy young. At weddings believed laughing.”</p>
					<ul class="list-inline mb-3">
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
					...
					<div class="d-flex align-items-center">
						...
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Carolyn Ortiz</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					<p class="mb-2">“I'm really happy with the Mizzle service. we've just launched our 5th website - they're amazing! At weddings believed laughing we've just launched our 5th website! You guys rock”</p>
					<ul class="list-inline mb-3">
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
					...
					<div class="d-flex align-items-center">
						<!-- Avatar -->
						<div class="avatar avatar-xs me-2">
							<img class="avatar-img rounded-circle" src="https://mizzle.webestica.com/assets/images/avatar/07.jpg" alt="avatar">
						</div>
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Dennis Barrett</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					<p class="mb-2">“I am really satisfied with my service. Thanks to service, we've just launched our 5th website! You guys rock!”</p>
					<ul class="list-inline mb-3">
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
					...
					<div class="d-flex align-items-center">
						<!-- Avatar -->
						<div class="avatar avatar-xs me-2">
							<img class="avatar-img rounded-circle" src="https://mizzle.webestica.com/assets/images/avatar/10.jpg" alt="avatar">
						</div>
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Lori Stevens</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					...
					<div class="d-flex align-items-center">
						...
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Joan Wallace</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					<p class="mb-2">“I am really satisfied with my service. You guys rock!”</p>
					<ul class="list-inline mb-3">
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
					...
					<div class="d-flex align-items-center">
						<!-- Avatar -->
						<div class="avatar avatar-xs me-2">
							<img class="avatar-img rounded-circle" src="https://mizzle.webestica.com/assets/images/avatar/11.jpg" alt="avatar">
						</div>
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Jacqueline Miller</small>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body border">
					<p class="mb-2">“We've just launched our 5th website - they're amazing! At weddings believed laughing we've just launched our 5th website! You guys rock”</p>
					<ul class="list-inline mb-3">
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
						<li class="list-inline-item me-0"><i class="bi bi-star-fill text-warning small"></i></li>
					...
					<div class="d-flex align-items-center">
						...
						<!-- Info -->
						<small class="mb-0 heading-color fw-semibold">Louis Ferguson</small>
					</div>
				</div>
			</div>
		</div>
