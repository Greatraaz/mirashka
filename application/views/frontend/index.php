    ...
    <div class="swiper overflow-hidden sliderh "   data-swiper-options='{
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="card overflow-hidden min-vh-100 rounded-0" style="background:url(https://mizzle.webestica.com/assets/images/bg/10.jpg) no-repeat; background-size:cover; background-position:center;">
                    <!-- Bg overlay -->
            ...
            <div class="swiper-slide">
                <div class="card overflow-hidden min-vh-100 rounded-0" style="background:url(https://mizzle.webestica.com/assets/images/bg/09.jpg) no-repeat; background-size:cover; background-position:center;">
                    <!-- Bg overlay -->
                    <div class="bg-overlay bg-linear-overlay"></div>
         ...
         <div class="col-sm-6 col-lg-4 col-xl-3">
            <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
               <div class="card-body p-0">
                  <!-- Logo -->
                  <div class="d-flex gap-3 align-items-center mb-3">
                     <img src="<?=base_url('assets/frontend/images/elements/mailchimp.s') ?>vg" class="h-40px" alt="Integrations-icon">
         ...
         <div class="col-sm-6 col-lg-4 col-xl-3">
            <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
               <div class="card-body p-0">
                  <!-- Logo -->
                  <div class="d-flex gap-3 align-items-center mb-3">
                     <img src="<?=base_url('assets/frontend/images/elements/google-driv') ?>e.svg" class="h-40px" alt="Integrations-icon">
