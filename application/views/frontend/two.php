		...
		<div class="row">
			...
			<div class="col-12 mx-auto">
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-analytics" role="tabpanel" aria-labelledby="pills-analytics-tab" tabindex="0">
						<div class="row align-items-center">
							...
							<div class="col-lg-5 position-relative ms-auto">
								...
								<!-- Image -->
								<img src="<?=base_url('assets/frontend/images/about/14.jpg') ?>" class="rounded position-relative zindex-2" alt="feature-img" style="width: 445px;height: 350px;object-fit: cover;">
							</div>
						</div>
					</div>
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-5 position-relative ms-auto">
								...
								<div class="d-inline-block bg-white shadow rounded-4 position-absolute end-0 bottom-0 p-3 mb-n5 me-lg-n6 d-none d-sm-block">
									<img src="<?=base_url('assets/frontend/images/elements/trustpilot.svg') ?>" class="h-20px mb-2" alt="Client-img">
									<div class="d-flex align-items-center">
										<img src="<?=base_url('assets/frontend/images/elements/trustpilot-star.svg') ?>" class="h-30px" alt="rating-img">
								...
								<!-- Image -->
								<img src="<?=base_url('assets/frontend/images/about/17.jpg') ?>" class="rounded" alt="feature-img" style="height: 380px;width: 450px;object-fit: cover;">		
							</div>
						</div>
					</div>
			...
			<div class="col-lg-10 col-xl-8 col-xxl-6 mx-auto mt-5">
				<div class="bg-light rounded-pill p-2">
					<ul class="nav nav-pills nav-pills-primary nav-responsive justify-content-between">
						...
						<li class="nav-item" role="presentation">
							<button class="nav-link rounded-pill" id="pills-collaboration-tab" data-bs-toggle="pill" data-bs-target="#pills-collaboration" type="button" role="tab" aria-controls="pills-collaboration" aria-selected="false"><i class="bi bi-basket me-2"></i>Collaboration</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link rounded-pill" id="pills-decoration-tab" data-bs-toggle="pill" data-bs-target="#pills-decoration" type="button" role="tab" aria-controls="pills-decoration" aria-selected="false"><i class="bi bi-gear me-2"></i>Automation</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link rounded-pill" id="pills-design-tab" data-bs-toggle="pill" data-bs-target="#pills-design" type="button" role="tab" aria-controls="pills-design" aria-selected="false"><i class="bi bi-pie-chart me-2"></i>Scalability</button>
						</li>
					</ul>
				</div>
			</div>
...
<section class="position-relative overflow-hidden pb-0 pt-xl-9">
	...
	<div class="position-absolute top-0 start-0 ms-n7 d-none d-xl-block">
		<img src="<?=base_url('assets/frontend/images/elements/decoration-pattern.svg') ?>" alt="">
	</div>
	...
	<div class="container pt-4 pt-sm-5">
		<div class="row g-xl-5">
			...
			<div class="col-md-10 col-xl-5 position-relative mx-auto mt-7 mt-xl-0">
				...
				<!-- Hero image -->
				<img src="<?=base_url('assets/frontend/images/bg/01.jpg') ?>" class="rounded" alt="hero-img">
				...
				<div class="d-inline-block card card-body shadow rounded-4 position-absolute end-0 top-0 p-3 me-lg-n3 me-xxl-n7 mt-n5 d-none d-sm-block">
					<img src="<?=base_url('assets/frontend/images/elements/trustpilot.svg') ?>" class="light-mode-item h-20px mb-2" alt="Client-img">
					<img src="<?=base_url('assets/frontend/images/elements/trustpilot-light.svg') ?>" class="dark-mode-item h-20px mb-2" alt="Client-img">
					<div class="d-flex align-items-center">
						<img src="<?=base_url('assets/frontend/images/elements/trustpilot-star.svg') ?>" class="h-30px" alt="rating-img">
			...
			<div class="col-lg-4 ms-auto mt-4 mt-lg-0">
				<div class="card bg-primary rounded h-100 overflow-hidden p-4">
					...
					<div class="position-absolute top-0 end-0 mt-n3 me-n4">
						<img src="<?=base_url('assets/frontend/images/elements/decoration-pattern-2.svg') ?>" class="opacity-2 h-200px" alt="">
					</div>
	...
	<div class="container">
		<div class="row">
								...
								<div class="card-footer bg-transparent p-0">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm flex-shrink-0 me-2">
											<img class="avatar-img rounded" src="<?=base_url('assets/frontend/images/avatar/03.jpg') ?>" alt="avatar">
										</div>
						...
						<div class="swiper-slide">
							<div class="card bg-transparent h-100">
								...
								<div class="card-footer bg-transparent p-0">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm flex-shrink-0 me-2">
											<img class="avatar-img rounded" src="<?=base_url('assets/frontend/images/avatar/01.jpg') ?>" alt="avatar">
										</div>
						...
						<div class="swiper-slide">
							<div class="card bg-transparent h-100">
								...
								<div class="card-footer bg-transparent p-0">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm flex-shrink-0 me-2">
											<img class="avatar-img rounded" src="<?=base_url('assets/frontend/images/avatar/02.jpg') ?>" alt="avatar">
										</div>
										<p class="mb-0">By Nix Maxwell</p>
									</div>
								</div>
						...
						<div class="swiper-slide">
							<div class="card bg-transparent h-100">
								...
								<div class="card-footer bg-transparent p-0">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm flex-shrink-0 me-2">
											<img class="avatar-img rounded" src="<?=base_url('assets/frontend/images/avatar/05.jpg') ?>" alt="avatar">
										</div>
			...
			<div class="col-sm-10 col-lg-6 col-xl-5 position-relative ms-xl-auto">
				<!-- Image -->
				<img src="<?=base_url('assets/frontend/images/about/03.jpg') ?>" class="rounded" alt="testimonial-img">
				...
				<div class="col-11 col-sm-8 position-absolute top-0 start-0 mt-n2 mt-sm-7 ms-n2 ms-sm-n7">
					<div class="bg-dark rounded d-flex align-items-center px-3 py-2">
						<!-- Avatar -->
						<div class="avatar avatar-sm flex-shrink-0 me-2">
							<img class="avatar-img rounded-circle" src="<?=base_url('assets/frontend/images/avatar/09.jpg') ?>" alt="avatar">
						</div>
