<section class="position-relative" style="background: url('https://siddharsh.com/wp-content/uploads/2025/04/bg_11zon.webp'); background-size: cover; background-position: center;">
...
<div class="container">
    <div class="row g-sm-6 align-items-center">
      ...
      <div class="col-lg-7 mb-5 mb-lg-0">
        <!-- Title -->
        <h2 class="text-white">Digital Marketing Solutions for Technology Companies and Startups</h2>
        <p class="mb-4 text-white">
          Elevate your business with our comprehensive services in brand strategy, digital transformation, and marketing consulting. Our expertise helps businesses enhance their visibility, strengthen their reputation, and drive measurable growth.
        </p>

        <!-- Service Buttons START -->
        <div>
          <button class="btn btn-primary rounded-pill px-3 mb-2 me-2"><i class="bi bi-brush"></i> Brand Strategy</button>
          <button class="btn btn-primary rounded-pill px-3 mb-2 me-2"><i class="bi bi-globe"></i> Digital Consulting</button>
          <button class="btn btn-primary rounded-pill px-3 mb-2 me-2"><i class="bi bi-bullseye"></i> Marketing Strategy</button>
          <button class="btn btn-primary rounded-pill px-3 mb-2 me-2"><i class="bi bi-gear"></i> Campaign Management</button>
          <button class="btn btn-primary rounded-pill px-3 mb-2 me-2"><i class="bi bi-bar-chart-line"></i> Analytics</button>
          <button class="btn btn-primary rounded-pill px-4 mb-2"><i class="bi bi-lightbulb"></i> Creative Solutions</button>
        </div>
        <!-- Service Buttons END -->

        <!-- Awards Section START -->
        <div class="banner-award-icons mt-4">
          <ul class="list-inline d-flex align-items-center justify-content-start">
            <li class="list-inline-item me-3">
              <img width="69" height="73" class="img-fluid" src="https://www.orangemantra.com/wp-content/uploads/2023/09/award2.png" alt="Award 1">
            </li>
            <li class="list-inline-item me-3">
              <img width="63" height="63" class="img-fluid" src="https://www.orangemantra.com/wp-content/uploads/2023/09/award3.png" alt="Award 2">
            </li>
            <li class="list-inline-item me-3">
              <img width="68" height="73" class="img-fluid" src="https://www.orangemantra.com/wp-content/uploads/2023/09/award5.png" alt="Award 3">
            </li>
            <li class="list-inline-item me-3">
              <img width="71" height="71" class="img-fluid" src="https://www.orangemantra.com/wp-content/uploads/2023/09/award2.png" alt="Award 4">
            </li>
            <li class="list-inline-item">
              <img width="77" height="77" class="img-fluid" src="https://www.orangemantra.com/wp-content/uploads/2023/09/award3.png" alt="Award 5">
            </li>
          </ul>
        </div>
        <!-- Awards Section END -->
      ...
      <!-- Image Column -->
      <div class="col-lg-5">
        <div class="card card-body shadow-lg border-0 position-relative overflow-hidden"
          style="background-image: url('https://media.istockphoto.com/id/1183506875/photo/medical-doctor-or-physician-staff-in-white-gown-uniform-with-stethoscope-in-hospital-or.webp?a=1&b=1&s=612x612&w=0&k=20&c=bClZVlaPBZ9yEhOetGZsQnnQNwFLptqn8nTe-Q6Z1jo='); background-size: cover; background-position: center; border-radius: 20px;">

          <!-- Overlay -->
          <div class="overlay position-absolute w-100 h-100"
            style="top: 0; left: 0; background-color: rgba(0, 0, 0, 0.6); z-index: 1; border-radius: 20px;"></div>

          <!-- Call to Action -->
          <div class="content position-relative text-center text-white py-5" style="z-index: 2;">
            <h4 class="fw-bold text-white">Let’s Build Your Brand Together</h4>
            <p class="mb-4">Contact us to discover tailored solutions for your business growth.</p>
            <button class="btn btn-success btn-lg rounded-pill shadow" id="getInTouchButton">Get in Touch</button>
          </div>
        </div>
      </div>
    </div>
...
<section class="pt-5 pb-5 ">
  <div class="container text-center">
    <!-- Client-Slider START -->
    <h3 class="heading-color fw-semibold mb-4">Trusted by Global  Clients</h3>
    <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper-options="{
      ...
      <div class="swiper-wrapper align-items-center">
        ...
        <div class="swiper-slide">
          <img src="https://www.blueoceancs.com/img/clients_logo/1_apollo.jpg" class="px-3" alt="Client-img">
        </div>
        <!-- Image -->
        <div class="swiper-slide">
          <img src="https://www.blueoceancs.com/img/clients_logo/1_apollo.jpg" class="px-3" alt="Client-img">
...
<section class="bg-light">
	<div class="container">
		<div class="row">
			<!-- Tab content START -->
			<div class="col-lg-6 col-xxl-5 pe-5 pe-xxl-0 order-2">
				<div class="bg-primary bg-opacity-10 rounded position-relative h-100 p-5">
					...
					<figure class="position-absolute top-0 start-0 ms-n7 mt-n5">
						<svg class="fill-mode" width="156" height="153" viewBox="0 0 156 153" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="tab-content h-100" id="feature-tabContent">
						<!-- Tab content item -->
						<div class="tab-pane fade h-100 show active" id="feature-01" role="tabpanel" aria-labelledby="feature-01-tab" tabindex="0">
							<div class="d-flex h-100">
								<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/10.png" class="m-auto" alt="decoration">
							</div>
						</div>
						<!-- Tab content item -->
						<div class="tab-pane fade h-100" id="feature-02" role="tabpanel" aria-labelledby="feature-02-tab" tabindex="0">
							<div class="d-flex h-100">
								<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/12.png" class="m-auto" alt="decoration">
							</div>
						</div>
						<!-- Tab content item -->
						<div class="tab-pane fade h-100" id="feature-03" role="tabpanel" aria-labelledby="feature-03-tab" tabindex="0">
							<div class="d-flex h-100">
								<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/11.png" class="m-auto" alt="decoration">
							</div>
						</div>
					</div>
				</div>	
			...
			<div class="col-lg-6 ms-auto h-100 order-1 order-lg-2 mb-5 mb-lg-0">
				<h2 class="mb-4">Transform your business with our powerful solutions</h2>
				<p class="mb-4">Comfort reached gay perhaps chamber his six detract besides add. Moonlight newspaper up its enjoyment.</p>

				<!-- Tabs START -->
				<div class="nav nav-pills nav-pills-border-start flex-column mb-3" id="feature-tab" role="tablist">
					<!-- Tab item -->
					<a href="#" class="nav-link active p-3 p-sm-4 mb-2" id="feature-01-tab" data-bs-toggle="pill" data-bs-target="#feature-01" role="tab" aria-controls="feature-01" aria-selected="true">
						<div class="d-flex">
							<!-- Icon -->
							<div class="icon-lg bg-body heading-color flex-shrink-0 border rounded"><i class="bi bi-share fs-6"></i></div>
							<!-- Content -->
							<div class="ms-3">
								<h6>Shared Data and Insights</h6>
								<p class="text-body text-wrap mb-0">Drawings offended yet answered perceive laughing six did far.</p>
							</div>
						</div>
					</a>

					<!-- Tab item -->
					<a href="#" class="nav-link p-3 p-sm-4 mb-2" id="feature-02-tab" data-bs-toggle="pill" data-bs-target="#feature-02" role="tab" aria-controls="feature-02" aria-selected="false">
						<div class="d-flex">
							<!-- Icon -->
							<div class="icon-lg bg-body heading-color flex-shrink-0 border rounded"><i class="bi bi-subtract fs-6"></i></div>
							<!-- Content -->
							<div class="ms-3">
								<h6>Collaboration tools</h6>
								<p class="text-body text-wrap mb-0">Demesne's new manners savings staying had under folly balls.</p>
							</div>
						</div>
					</a>

					<!-- Tab item -->
					<a href="#" class="nav-link p-3 p-sm-4 mb-2" id="feature-03-tab" data-bs-toggle="pill" data-bs-target="#feature-03" role="tab" aria-controls="feature-03" aria-selected="false">
						<div class="d-flex">
							<!-- Icon -->
							<div class="icon-lg bg-body heading-color flex-shrink-0 border rounded"><i class="bi bi-megaphone fs-6"></i></div>
							<!-- Content -->
							<div class="ms-3">
								<h6>Real-time notifications and alerts</h6>
								<p class="text-body text-wrap mb-0">Express besides it present if at an opinion visitor.</p>
							</div>
						</div>
					</a>
				</div>
				...
				<!-- Info -->
				<p class="mt-3 mb-0">
					<i class="bi bi-info-square-fill heading-color me-2"></i>Contact our team for more information 
					<a href="contact-v1.html" class="icon-link icon-link-hover text-decoration-underline">Let's chat<i class="bi bi-arrow-right"></i></a>
				</p>
				<!-- Tabs END -->
			</div>
			<!-- Title and tabs END -->
	...
	<div class="container position-relative">
		<div class="row align-items-start">
			...
			<div class="col-lg-6 col-xl-5 position-relative text-center order-1 mt-6 mt-lg-0">
				...
				<!-- Image -->
				<img src="https://mizzle.webestica.com/assets/images/about/06.jpg" class="rounded position-relative" alt="about-img">
			</div>

			<!-- feature content -->
			<div class="col-lg-6 ms-auto position-relative order-lg-2">
				<h2 class="mb-4 mb-md-5">Quick and Effective Accessibility Testing</h2>
		...
		<div class="row g-4 g-xl-6">
			...
			<div class="col-lg-6">
				<div class="card border p-0 h-100">
					<!-- Content -->
					<div class="card-body p-4 py-sm-5 px-sm-7 text-center">
						<h5 class="mb-3">Work with your favorite tools</h5>
						<p class="mb-4">You have the freedom to use the tools and software you prefer or find most effective in your job or tasks.</p>
						<a href="integrations.html" class="btn btn-sm btn-dark mb-0">View all integrations</a>
					</div>
					<!-- Image -->
					<div class="card-footer p-0">
						<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/18.png" alt="">
					</div>
				</div>
			</div>
			...
			<div class="col-lg-6">
				<div class="card border overflow-hidden p-0 h-100">
					<!-- Content -->
					<div class="card-body p-4 py-sm-5 px-sm-7 text-center">
						<h5 class="mb-3">Extract code ready for implementation</h5>
						<p class="mb-4">Code you're providing or generating is of high quality, thoroughly tested, and fully prepared for deployment.</p>
						<a href="#" class="btn btn-sm btn-dark mb-0">Discover our theme</a>
					</div>
					<!-- Image -->
					<div class="card-footer p-0 mb-n3 ms-5">
						<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/19.png" alt="">
					</div>
				</div>
			</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card border overflow-hidden p-0 h-100">
					...
					<div class="card-body p-sm-5 text-center">
						<h5 class="mb-3">24/7 fast chat supports</h5>
						<p class="mb-0">Enjoy around-the-clock, lightning-fast chat support.</p>
					</div>
					<!-- Image -->
					<div class="card-footer p-0">
						<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/20.png" alt="">
					</div>
				</div>
			</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card border overflow-hidden p-0 h-100">
					<!-- Content -->
					<div class="card-body p-sm-5 text-center">
						<h5 class="mb-3">Secure data encryption</h5>
						<p class="mb-0">It stands as a cornerstone in ensuring the confidentiality</p>
					</div>
					<!-- Image -->
					<div class="card-footer p-0">
						<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/22.png" alt="">
					</div>
				</div>
			</div>
			...
			<div class="col-xl-4">
				<div class="card border overflow-hidden p-0 h-100">
					...
					<div class="card-body p-sm-5 text-center">
						...
						<p class="mb-0">Seamlessly collaborate with your team members like never before</p>
					</div>
					<!-- Image -->
					<div class="card-footer p-0">
						<img src="https://mizzle.webestica.com/assets/images/elements/saas-decoration/21.png" alt="">
					</div>
				</div>
			</div>
		</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="mb-3">
            <label for="industry" class="form-label fw-bold small">Industry/Business Name</label>
            <div class="input-group input-group-sm">
              <span class="input-group-text bg-primary text-white"><i class="bi bi-building"></i></span>
              <input type="text" class="form-control" id="industry" placeholder="Your Industry or Business Name">
            </div>
          </div>

          <!-- Services Interested In -->
          <div class="mb-3">
            <label for="services" class="form-label fw-bold small">Services Interested In</label>
            <div class="input-group input-group-sm">
              <span class="input-group-text bg-primary text-white"><i class="bi bi-briefcase"></i></span>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control form-control-sm" id="message" rows="2" placeholder="Your Message"></textarea>
          </div>
        </form>
...
<!-- Script for Modal -->
<script>
  document.getElementById('getInTouchButton').addEventListener('click', () => {
      ...
      <div class="col-md-11 mx-auto">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 col-lg-5 mb-4 mb-md-0">
            <img src="<?= base_url('assets/frontend/images/about/21.jpg') ?> " class="rounded" alt="">
          </div>
          <!-- Content -->
          <div class="col-md-6 ms-auto">
            <h3 class="mb-md-4">Transform healthcare with digital solutions!</h3>
            <p class="mb-md-4">Mirashka is a leading innovator in healthcare marketing and technology. We specialize in inbound marketing strategies, medical software development, and implementing solutions for healthcare practitioners to enhance brand recognition and positioning in target markets efficiently.</p>
            <p class="mb-md-4">Whether you're a small startup or a large enterprise, we have the expertise to meet your needs.</p>
  ...
  <div class="container">
    ...
    <div class="row align-items-center mb-4 mb-md-6">
      <div class="col-md-6 mb-3 mb-md-0">
        <h3 class="mb-0">Customized Solutions for Healthcare Excellence!</h3>
      </div>
      <div class="col-md-4 ms-auto text-md-end">
        <a href="#" class="btn btn-dark btn-lg shadow-lg rounded-pill mb-0">View all services</a>
      </div>
    </div>
    ...
    <div class="swiper" data-swiper-options='{
      ...
      <div class="swiper-wrapper">
        <!-- Card 1 -->
        <div class="swiper-slide">
          <div class="card bg-primary text-white p-5 mt-lg-7 shadow-lg rounded-lg service-card">
            <div class="card-header bg-transparent d-flex justify-content-between p-0 pb-4">
              <h5 class="me-4 mb-0"><a href="#" class="stretched-link text-white">SEO Training and Workshops</a></h5>
              <a href="#" class="btn btn-round btn-light border flex-shrink-0"><i class="bi bi-arrow-up-right"></i></a>
            </div>
            <div class="card-body p-0">
              <figure class="heading-color mb-4">
                <i class="bi bi-bar-chart-fill" style="font-size: 3rem;"></i>
              </figure>
              <span>What included:</span>
              <p class="fw-semibold mb-0 mt-2">Fundamentals of SEO, Keyword research, Reporting, and Algorithm updates</p>
            </div>
          </div>
        </div>
        ...
        <!-- Card 2 -->
        <div class="swiper-slide">
          <div class="card bg-dark text-light p-5 mt-lg-4 shadow-lg rounded-lg service-card">
            <div class="card-header bg-transparent d-flex justify-content-between p-0 pb-4">
              <h5 class="me-4 mb-0"><a href="#" class="stretched-link text-light">Mobile SEO Optimization</a></h5>
              <a href="#" class="btn btn-round btn-light border flex-shrink-0"><i class="bi bi-arrow-up-right"></i></a>
            </div>
            <div class="card-body p-0">
              <figure class="heading-color mb-4 ">
              ...
              <span class="text-light">What included:</span>
              <p class="fw-semibold mb-0 mt-2 text-light">Optimizing page speed, mobile responsiveness, and usability factors</p>
            </div>
          </div>
        </div>
        ...
        <!-- Card 3 -->
        <div class="swiper-slide">
          <div class="card bg-light text-dark border p-5 shadow-lg rounded-lg service-card">
            <div class="card-header bg-transparent d-flex justify-content-between p-0 pb-4">
              <h5 class="me-4 mb-0"><a href="#" class="stretched-link text-dark">Content Strategy and Creation</a></h5>
              <a href="#" class="btn btn-round btn-dark border flex-shrink-0"><i class="bi bi-arrow-up-right"></i></a>
            </div>
            <div class="card-body p-0">
              <figure class="heading-color mb-4">
                <i class="bi bi-pencil-fill" style="font-size: 3rem;"></i>
              </figure>
              <span>What included:</span>
              <p class="fw-semibold mb-0 mt-2">Audience Research, Keyword Analysis, Content Planning, Optimization</p>
            </div>
          </div>
        </div>
      </div>
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6 mb-5 mb-lg-0">
				<!-- Title -->
				<h2 class="mb-3 mb-lg-5">Effortless Download and Installation of Mizzle</h2>
				...
				<div class="d-flex align-items-center gap-3 mb-3">
					...
					<h6 class="fw-normal mb-0">Navigate to the 'Download' Page</h6>
				</div>
				...
				<div class="d-flex align-items-center gap-3">
					...
					<h6 class="fw-normal mb-0">Sign In and Start Using</h6>
				</div>

				<!-- Download button -->
				<div class="row g-2 mt-3 mt-lg-5">
					<!-- Google play store button -->
					<div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3">
						<a href="#"> <img src="https://mizzle.webestica.com/assets/images/elements/google-play.svg" class="btn-transition" alt="google-store"> </a>
					</div>
					<!-- App store button -->
					<div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3">
						<a href="#"> <img src="https://mizzle.webestica.com/assets/images/elements/app-store.svg" class="btn-transition" alt="app-store"> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-5 position-relative ms-auto">
				...
				<!-- Image -->
				<img src="https://mizzle.webestica.com/assets/images/about/14.jpg" class="rounded-3 position-relative" alt="">
			</div>
		</div> <!-- Row END -->
	</div>
</section>
...
<!-- =======================
CTA START -->
<section class="bg-light bg-opacity-10">
	<div class="container">
		<div class="row g-sm-6 align-items-center">
			<!-- Content -->
