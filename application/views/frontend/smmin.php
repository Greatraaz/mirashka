		...
		<div class="row g-4 g-lg-6">
			...
			<div class="col-xl-8">
				<div class="row g-4 g-lg-6">
					...
					<!-- Feature item -->
					<div class="col-lg-6">
						<div class="card bg-white rounded h-100 overflow-hidden p-4">
							<!-- Card body -->
							<div class="card-body bg-transparent p-0">
								<!-- Icon SVG -->
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 ps-xl-7">
				...
				<p>At Mizzle, we're not just in the business of digital solutions; we're in the business of crafting digital success stories. Founded on a passion for innovation and a commitment to excellence, we've been at the forefront of the digital landscape, helping businesses like yours thrive in the digital age.</p>
...
<Section class="pt-0">
	<div class="container">
		...
		<div class="inner-container-small text-center mb-4 mb-sm-7">
			<span class="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2">Final solution</span>
		...
		<div class="row g-4 g-lg-5">
			...
			<div class="col-md-5 h-100">
				<img src="https://mizzle.webestica.com/assets/images/about/05.jpg" class="rounded-3" alt="">
			</div>
				...
				<div class="row g-4 g-lg-5">
					...
					<div class="col-lg-6">
						<div class="card bg-light rounded h-100 overflow-hidden p-5">
							<!-- Card body -->
							<div class="card-body bg-transparent p-0">
								<div class="badge text-bg-dark mb-3">Feature</div>
								<p class="small mb-0">Skyrocket your business to unprecedented heights with the right tools today</p>
							</div>
					...
					<div class="col-lg-6">
						<div class="card bg-light rounded h-100 overflow-hidden p-5">
							...
							<div class="card-body bg-transparent p-0">
								...
								<p class="small mb-0">Elevate your business to new heights with the right tools today.</p>
							</div>
					...
					<div class="col-12">
						<div class="card bg-light rounded h-100 overflow-hidden p-5">
							<!-- Card body -->
							<div class="card-body bg-transparent p-0">
								<div class="badge text-bg-danger mb-3">Revenue</div>
								<p class="small mb-0">Unlock the full potential of your business and elevate it to new heights by harnessing the power of cutting-edge tools and technologies available today.</p>
							</div>
