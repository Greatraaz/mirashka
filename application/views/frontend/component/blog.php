		...
		<div class="row g-4 g-xl-5">
			...
			<div class="col-md-4">
				<article class="card card-img-scale shadow overflow-hidden h-100">
					...
					<div class="card-img-scale-wrapper">
						<img src="https://mizzle.webestica.com/assets/images/blog/4by3/03.jpg" class="img-scale card-img-top" alt="Blog-img">
					</div>
			...
			<div class="col-md-4">
				<article class="card card-img-scale shadow overflow-hidden h-100">
					<!-- Image -->
					<div class="card-img-scale-wrapper">
						<img src="https://mizzle.webestica.com/assets/images/blog/4by3/01.jpg" class="img-scale card-img-top" alt="Blog-img">
					</div>
			...
			<div class="col-md-4">
				<article class="card card-img-scale shadow overflow-hidden h-100">
					<!-- Image -->
					<div class="card-img-scale-wrapper">
						<img src="https://mizzle.webestica.com/assets/images/blog/4by3/07.jpg" class="img-scale card-img-top" alt="Blog-img">
					</div>
