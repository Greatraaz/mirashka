	...
	<div class="container position-relative pt-4 pt-sm-6">
		<div class="row">
			...
			<div class="col-lg-6 mb-5 mb-sm-8 mb-md-9 mb-lg-0">
				<!-- Title -->
				<h1 class="position-relative lh-base mb-4">Get accurate plant diagnoses in an instant with Mizzle.
					<!-- SVG decoration -->
				...
				<p class="mb-5">Download the app for free and get access to accurate plant diagnoses with no extra charges.</p>
				...
				<div class="d-sm-flex gap-3 align-items-center">
					<h6 class="mb-3 mb-sm-0">Global Partner:</h6>
			...
			<div class="col-lg-6 position-relative">
				...
				<div class="bg-body shadow d-none d-sm-block heading-color fw-semibold position-absolute top-0 start-50 translate-middle mt-n6 px-3 py-2 ms-n4">
					<i class="bi bi-patch-check-fill text-primary me-2"></i>Secure & Verified
				</div>
				<!-- Avatar decoration -->
				<div class="avatar avatar-lg position-absolute top-0 start-0 mt-n8 ms-8">
					<img class="avatar-img rounded-circle d-none d-md-block" src="https://mizzle.webestica.com/assets/images/avatar/01.jpg" alt="avatar">
				</div>
				<!-- Avatar decoration -->
				<div class="avatar position-absolute bottom-50 start-0 mb-n8 ms-n5">
					<img class="avatar-img rounded-circle d-none d-lg-block" src="https://mizzle.webestica.com/assets/images/avatar/07.jpg" alt="avatar">
				</div>
				<!-- Avatar decoration -->
				<div class="avatar position-absolute bottom-0 end-0 me-8">
					<img class="avatar-img rounded-circle" src="https://mizzle.webestica.com/assets/images/avatar/14.jpg" alt="avatar">
				</div>
				<!-- SVG decoration -->
				...
				<div class="row">
					<!-- Mockup 1 -->
					<div class="col-sm-6">
						<div class="iphone-x iphone-x-small rotate-sm-343 m-auto m-sm-0 ms-sm-5 mt-4 z-index-99" style="background: url(https://mizzle.webestica.com/assets/images/mokeup/app-placeholder.jpg); background-size: 100%;">
							<i></i>
							<b></b>
					...
					<div class="col-6 d-none d-sm-block">
						<div class="iphone-x iphone-x-small rotate-13 m-0 ms-3 mt-xl-n7" style="background: url(https://mizzle.webestica.com/assets/images/mokeup/app-placeholder2.jpg); background-size: 100%;">
							<i></i>
							<b></b>
						</div>
					</div>
	...
	<div class="container">
		<div class="bg-light rounded position-relative overflow-hidden p-4 p-sm-6">
			...
			<div class="position-absolute end-0 bottom-0 me-5">
				<img src="https://mizzle.webestica.com/assets/images/elements/cta-vector.svg" class="h-200px" alt="vector-img">
			</div>
			...
			<div class="row g-4">
				...
				<div class="col-lg-5">
					<!-- Title -->
					<h2 class="mb-4">Anywhere, Any Time, Any Platform</h2>
				...
				<div class="col-lg-5">
					<!-- Mobile image -->
					<div class="iphone-x iphone-x-small ms-lg-auto m-0 mb-n9" style="background: url(https://mizzle.webestica.com/assets/images/mokeup/app-placeholder6.jpg); background-size: 100%; width: 280px; height:430px">
						<i></i>
						<b style="left:6%;"></b>
					</div>
				</div>
