...
<footer class="position-relative overflow-hidden pb-0 pt-6 pt-lg-8" data-bs-theme="dark" style="background-color: rgba(32, 33, 36);">
   ...
   <div class="position-absolute top-0 end-0 mt-n3 me-n4">
      <img src="https://mizzle.webestica.com/assets/images/elements/decoration-pattern-2.svg" style="opacity:0.05;" alt="">
   </div>
   ...
   <div class="container position-relative mt-5">
      <div class="row g-4 justify-content-between">
         ...
         <div class="col-lg-3">
            ...
            <p class="mt-4 mb-2">Elevate your online presence and embark on a journey to digital excellence with our meticulously designed digital agency theme. we are commited to providing a robust and versatile platform that accommodates the diverse needs of digital agencies.</p>
         </div>
         <!-- Widget 1 END -->
               ...
               <div class="col-md-4">
                  ...
                  <div class="row g-2 mt-2 mb-4 mb-sm-5">
                     ...
                     <div class="col-5 col-sm-4 col-md-6">
                        <a href="#"> <img src="https://mizzle.webestica.com/assets/images/elements/google-play.svg" alt=""> </a>
                     </div>
                     <!-- App store button -->
                     <div class="col-5 col-sm-4 col-md-6">
                        <a href="#"> <img src="https://mizzle.webestica.com/assets/images/elements/app-store.svg" alt="app-store"> </a>
                     </div>
                  </div>
      ...
      <div class="d-md-flex justify-content-center align-items-center text-center py-4">
         <div class="text-body"> Copyrights ©2025 | All Rights Reserved | MIRASHKA</div>
         <!-- <div class="dropdown dropup text-center text-md-end mt-3 mt-md-0">
            ...
            <ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
               <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="https://mizzle.webestica.com/assets/images/flags/uk.svg" alt="">English</a></li>
               <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="https://mizzle.webestica.com/assets/images/flags/gr.svg" alt="">German </a></li>
               <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="https://mizzle.webestica.com/assets/images/flags/sp.svg" alt="">French</a></li>
            </ul>
         </div> -->
      </div>
   </div>
