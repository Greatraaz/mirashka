				...
				<div class="swiper swiper-img-scale h-100" data-swiper-options='{
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="h-100 scale-img py-9" style="background-image:url(https://mizzle.webestica.com/assets/images/bg/07.jpg); background-position: center left; background-size: cover;"></div>
						</div>

						<!-- Slider item -->
						<div class="swiper-slide">
							<div class="h-100 scale-img py-9" style="background-image:url(https://mizzle.webestica.com/assets/images/bg/12.jpg); background-position: center left; background-size: cover;"></div>
						</div>
						
						<!-- Slider item -->
						<div class="swiper-slide">
							<div class="h-100 scale-img py-9" style="background-image:url(https://mizzle.webestica.com/assets/images/bg/13.jpg); background-position: center left; background-size: cover;"></div>
						</div>
					</div>
				</div>
			</div>
...
<div class="swiper pt-5 pb-5 swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper-options="{
   &quot;spaceBetween&quot;: 50, 
   &quot;speed&quot;:&quot;14000&quot;,
   &quot;autoplay&quot;:{
   &quot;delay&quot;: 0, 
   ...
   &quot;1400&quot;: {&quot;slidesPerView&quot;: 5}
	...
	<div class="swiper-wrapper align-items-center" id="swiper-wrapper-c0102934b4fe0249e" aria-live="off" style="transition-duration: 14000ms; transform: translate3d(-344.25px, 0px, 0px);">
		<!-- Slider item -->
		<div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 9" data-swiper-slide-index="0" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/01.jpg" class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide swiper-slide-active" role="group" aria-label="2 / 9" data-swiper-slide-index="1" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/02.jpg " class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 9" data-swiper-slide-index="2" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/12.jpg" class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide" role="group" aria-label="4 / 9" data-swiper-slide-index="3" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/04.jpg" class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide" role="group" aria-label="5 / 9" data-swiper-slide-index="4" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/14.jpg" class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide" role="group" aria-label="6 / 9" data-swiper-slide-index="5" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/bg/01.jpg " class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide" role="group" aria-label="7 / 9" data-swiper-slide-index="6" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/16.jpg" class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide" role="group" aria-label="8 / 9" data-swiper-slide-index="7" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/08.jpg" class="rounded" alt="">
		</div>
		<!-- Slider item -->
		<div class="swiper-slide" role="group" aria-label="9 / 9" data-swiper-slide-index="8" style="width: 294.25px; margin-right: 50px;">
			<img src="http://localhost/mirashkadigital/assets/frontend/images/about/03.jpg " class="rounded" alt="">
		</div>
	</div>
				...
				<div class="row flex-lg-nowrap align-items-center position-relative mb-8">
					...
					<div class="col-lg-7">
						<div class="bg-light rounded px-5 ps-md-6 py-7 pe-md-8">
							...
							<!-- Button -->
							<a class="btn btn-dark icon-link icon-link-hover" href="#">Get started now<i class="bi bi-arrow-right"></i> </a>
						</div>	
					</div>
...
<!-- =======================
Newsletter START -->
<section class="position-relative z-index-2 pb-0">
	<div class="container position-relative">

		<div class="bg-dark rounded position-relative overflow-hidden p-4 p-sm-6" data-bs-theme="dark">
			<!-- Decoration -->
			<figure class="position-absolute top-0 start-0 mt-n5 ms-n5">
			...
			<!-- Decoration -->
			<figure class="position-absolute top-0 start-100 translate-middle opacity-5 mt-7 ms-n5">
				<svg width="290" height="290" viewBox="0 0 290 290" fill="none" xmlns="http://www.w3.org/2000/svg">
					<circle opacity="0.5" cx="145.313" cy="145.313" r="144.5" transform="rotate(39.2153 145.313 145.313)" fill="url(#paint0_linear_266_283)"></circle>
					<defs>
			...
			<div class="row align-items-center position-relative">
				...
				<div class="col-md-6 col-xl-7 mb-4 mb-xl-0">
					...
					<p class="mb-0">Join the Mizzle revolution today and be part of the millions who've already embraced a brighter future!</p>
				</div>
