<!-- =======================
Main Banner START -->
<section class="vh-xl-auto vh-100 bg-pawan py-0 overflow-hidden bg-black">
		...
		<div class="row h-100 g-0">
			...
			<div class="col-lg-6 m-auto order-2">
				<div class="px-5 px-xxl-8 py-6 py-lg-8">
					...
					<!-- Pre title -->
					<div class="alert alert-light rounded-pill d-inline-block py-2 px-3 mb-4">
						<span class="badge text-black rounded-pill me-sm-2 px-sm-3">RESUME OPTIMIZATION</span>
					</div>
					
					<!-- Title -->
					<h1 class="display-6 mb-4 text-white">Resume Analyzer</h1>
					<p class="mb-4 mb-xl-5 text-white">
						Your resume is more than just a document—it’s the key to unlocking career opportunities. 
						Showcase your <strong>skills, experience, and achievements</strong> effectively with our 
						<strong>Resume Analyzer</strong>. Let us help you <strong>stand out</strong>, bypass HR filters, 
						and land in the <strong>"yes" pile</strong>.
					</p>

                    <ul class="list-inline d-flex flex-wrap gap-2 gap-sm-4 mb-0 mt-4 mt-xl-5">
						<li class="list-inline-item heading-color text-white"> <i class="bi bi-person-check me-1"></i> ATS-Friendly Formatting</li>
						<li class="list-inline-item heading-color text-white"> <i class="bi bi-lightbulb me-1"></i> Keyword Optimization</li>
						
					</ul>

                    <div class="d-flex gap-1 gap-sm-3 flex-wrap mt-1 mb-2 mt-xl-5">
						<button class="btn btn-dark text-white" type="button">Analyze My Resume</button>
						<button class="btn btn-outline-dark" text-white type="button">Try a Free Demo</button>
					</div>
				...
				<div class="row">
					<div class="col-lg-11 col-xl-9 position-relative ms-auto">
						...
						<div class="card border p-4">
							...
							<!-- Image -->
							<img src="https://mizzle.webestica.com/assets/images/about/07.jpg" class="card-img mb-3" alt="card image">
							<!-- Title -->
		...
		<div class="row g-4 g-sm-6">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/01.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/02.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
					<div class="card-body text-center px-0 pb-0">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/03.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
					<div class="card-body text-center px-0 pb-0">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/04.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
					<div class="card-body text-center px-0 pb-0">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="position-absolute top-0 end-0 z-index-2 m-3">
						<ul class="list-inline mb-0 mb-2 mb-sm-0">
							<li class="list-inline-item"> <a class="btn-icon btn-sm rounded mb-2 bg-instagram-gradient" href="#"><i class="fab fa-fw fa-instagram"></i></a> </li> </li>
						</ul>
					</div>
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/05.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
					<div class="card-body text-center px-0 pb-0">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/06.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
					<div class="card-body text-center px-0 pb-0">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/07.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
					<div class="card-body text-center px-0 pb-0">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-img-scale bg-transparent overflow-hidden">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Card Image -->              
						<img src="https://mizzle.webestica.com/assets/images/team/08.jpg" class="img-scale" alt="card image">
					</div>
					<!-- Card body -->
					<div class="card-body text-center px-0 pb-0">
